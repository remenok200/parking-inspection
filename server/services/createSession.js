...
module.exports.createAccessToken = async ({ userId, email, role, geolocation }) =>
...
module.exports.createRefreshToken = async ({ userId, email, role, geolocation }) =>
  await promisifyJWTSign({ userId, email, role, geolocation }, REFRESH_SECRET, {
